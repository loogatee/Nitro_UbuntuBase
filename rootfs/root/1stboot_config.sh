...
sed -n '
1,/^ENDOFFILE/ {
   /^exit 0/i modprobe g_multi file=/dev/mmcblk0p2 cdrom=0 stall=0 removable=1 nofua=1 iManufacturer=BDAT  iSerialNumber=3456 iProduct=Apex2 host_addr=00:1D:7B:11:22:33\n
   /^exit 0/i sleep 1\n
